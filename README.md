...
| ⚡ Power Management    | [upower](https://archlinux.org/packages/extra/x86_64/upower/) · [poweralertd](https://sr.ht/~kennylevinsen/poweralertd/) · [tuned](https://wiki.archlinux.org/title/CPU_frequency_scaling#tuned) ﹢ [tuned-gui](https://wiki.archlinux.org/title/CPU_frequency_scaling#tuned) | https://wiki.archlinux.org/title/Laptop_Mode_Tools | _[Arch Wiki](https://wiki.archlinux.org/title/Power_management)_ ➟ _sudo systemctl enable --now tuned_|
