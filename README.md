...
| 📶 Network Drivers & Utils     | ethtool · iwd · [networkmanager](https://wiki.archlinux.org/title/NetworkManager) ﹢ [nm-connection-editor](https://archlinux.org/packages/extra/x86_64/nm-connection-editor/) · wireless-regdb | [impala](https://github.com/pythops/impala) |  _sudo systemctl enable --now NetworkManager.service_ → _[nm_config](https://github.com/p2ndemic/dotfiles/blob/main/etc/NetworkManager/conf.d/99-iwd.conf)_ → _[iwd_config](https://github.com/p2ndemic/dotfiles/blob/main/etc/iwd/main.conf)_ → _rfkill unblock wlan_|
