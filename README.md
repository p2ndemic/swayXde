...
| 🎚️ Wireplumber & Utils    | [wireplumber](https://archlinux.org/packages/extra/x86_64/wireplumber/) · [rtkit](https://archlinux.org/packages/extra/x86_64/rtkit/) | | _[Arch Wiki](https://wiki.archlinux.org/title/WirePlumber)_ ➟ systemctl --user enable --now wireplumber ➟ sudo systemctl enable --now rtkit |
| 🌊 GStreamer                 | | |  |
| 📼 FFmpeg                    | | |  |
