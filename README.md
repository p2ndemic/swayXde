...
| 🗃️ File System Utils  | [efitools](https://archlinux.org/packages/extra/x86_64/efitools/) · [smartmontools](https://archlinux.org/packages/extra/x86_64/smartmontools/) · [xfsprogs](https://archlinux.org/packages/core/x86_64/xfsprogs/) · [f2fs-tools](https://archlinux.org/packages/extra/x86_64/f2fs-tools/) · [e2fsprogs](https://archlinux.org/packages/core/x86_64/e2fsprogs/) · [dosfstools](https://archlinux.org/packages/core/x86_64/dosfstools/) · [exfatprogs](https://archlinux.org/packages/extra/x86_64/exfatprogs/) · [ntfs-3g](https://archlinux.org/packages/extra/x86_64/ntfs-3g/) · [squashfs-tools](https://archlinux.org/packages/extra/x86_64/squashfs-tools/) · [gparted](https://archlinux.org/packages/extra/x86_64/gparted/) | [nfs-utils](https://wiki.archlinux.org/title/NFS) · [nilfs-utils](https://wiki.archlinux.org/title/NILFS2) | _[Arch Wiki](https://wiki.archlinux.org/title/File_systems)_ ➟ _[xfs_config](https://github.com/p2ndemic/dotfiles/blob/main/etc/sysctl.d/99-xfs-sync-interval.conf)_ ➟ _sudo systemctl enable --now fstrim.timer_ ➟ _sudo systemctl enable --now xfs_scrub_all.timer_ |
| 🔧 Hardware Utils     | [dmidecode](https://archlinux.org/packages/extra/x86_64/dmidecode/) · [hwdetect](https://wiki.archlinux.org/title/Hwdetect) · [hdparm](https://archlinux.org/packages/core/x86_64/hdparm/) · [lsscsi](https://archlinux.org/packages/extra/x86_64/lsscsi/) · [sg3_utils](https://archlinux.org/packages/extra/x86_64/sg3_utils/) · [usbutils](https://archlinux.org/packages/core/x86_64/usbutils/) | [hwinfo](https://archlinux.org/packages/extra/x86_64/hwinfo/) · [dmraid](https://archlinux.org/packages/core/x86_64/dmraid/) |
| 🕒 NTP<br>Daemon         | [systemd-timesyncd](https://www.freedesktop.org/software/systemd/man/latest/systemd-timesyncd.service.html) | [chrony](https://wiki.archlinux.org/title/Chrony) | _[Arch Wiki](https://wiki.archlinux.org/title/Systemd-timesyncd)_ ➟ _[timesyncd_config](https://github.com/p2ndemic/dotfiles/blob/main/etc/systemd/timesyncd.conf.d/99-local.conf)_ ➟ _sudo systemctl enable --now systemd-timesyncd.service_ |
| ⚡ Power Management   | [upower](https://archlinux.org/packages/extra/x86_64/upower/) · [poweralertd](https://sr.ht/~kennylevinsen/poweralertd/) · [tuned](https://wiki.archlinux.org/title/CPU_frequency_scaling#tuned) ﹢ [ [systemtap](https://archlinux.org/packages/extra/x86_64/systemtap/) · [wireless_tools](https://archlinux.org/packages/extra/x86_64/wireless_tools/) · [x86_energy_perf_policy](https://archlinux.org/packages/extra/x86_64/x86_energy_perf_policy/) ] | [tuned-ppd](https://archlinux.org/packages/extra/any/tuned-ppd/) · [laptop-mode-tools](https://wiki.archlinux.org/title/Laptop_Mode_Tools) | _[Arch Wiki](https://wiki.archlinux.org/title/Power_management)_ ➟ _[tuned Wiki](https://wiki.archlinux.org/title/TuneD)_ ➟ _sudo systemctl enable --now tuned.service_ ➟ _systemctl --user enable --now poweralertd.service_|
...
| 🧊 Archiving & Compression | [zlib-ng](https://archlinux.org/packages/extra/x86_64/zlib-ng/) · [zlib-ng-compat](https://archlinux.org/packages/extra/x86_64/zlib-ng-compat/) · [libarchive](https://archlinux.org/packages/core/x86_64/libarchive/) · [7zip](https://archlinux.org/packages/extra/x86_64/7zip/) · [arqiver](https://aur.archlinux.org/packages/arqiver) | [unzip](https://archlinux.org/packages/extra/x86_64/unzip/) · [unrar](https://archlinux.org/packages/extra/x86_64/unrar/)
...
| 🔹 Intel<br>VA-API         | [intel-media-driver](https://archlinux.org/packages/extra/x86_64/intel-media-driver/) · [vpl-gpu-rt](https://archlinux.org/packages/extra/x86_64/vpl-gpu-rt/) · [libvpl-tools](https://archlinux.org/packages/extra/x86_64/libvpl-tools/) | | _[Arch Wiki](https://wiki.archlinux.org/title/Hardware_video_acceleration)_ ➟ _env LIBVA_DRIVER_NAME=iHD_ |
...
| 🌡️ Intel Thermal Daemon | [intel-lpmd](https://archlinux.org/packages/extra/x86_64/intel-lpmd/) | [thermald](https://archlinux.org/packages/extra/x86_64/thermald/) | _[Arch Wiki](https://wiki.archlinux.org/title/CPU_frequency_scaling#thermald)_ ➟ _sudo systemctl enable --now thermald_ _(Not recommended on laptops, as it may cause lag)_ |
| 🧪 Intel<br>GPU Tools      | _optional_ | [intel-gpu-tools](https://archlinux.org/packages/extra/x86_64/intel-gpu-tools/) |
...
| 🔸 AMD<br>VA-API    | [mesa](https://archlinux.org/packages/extra/x86_64/mesa/) | | _[Arch Wiki](https://wiki.archlinux.org/title/Hardware_video_acceleration)_ ➟ _env LIBVA_DRIVER_NAME=radeonsi_ |
| 🔧 adriconf               | _optional_ | [adriconf](https://archlinux.org/packages/extra/x86_64/adriconf/) | 
...
| 🔹 DNS Resolver                 | [systemd-resolved](https://wiki.archlinux.org/title/Systemd-resolved) | [unbound](https://wiki.archlinux.org/title/Unbound) · [dnsconfd](https://github.com/InfrastructureServices/dnsconfd)| _[Arch Wiki](https://wiki.archlinux.org/title/Domain_name_resolution)_ ➟ _[systemd-resolved_config](https://github.com/p2ndemic/dotfiles/blob/main/etc/systemd/resolved.conf.d/99-resolved.conf)_ ➟ _sudo systemctl enable --now systemd-resolved.service_ ➟ _**[disable Avahi]**_ ➟ _sudo systemctl disable --now avahi-daemon.service avahi-daemon.socket_ ➟ _sudo systemctl mask avahi-daemon.service avahi-daemon.socket_ |
...
| 🪄 Wireplumber & Utils | [wireplumber](https://archlinux.org/packages/extra/x86_64/wireplumber/) · [rtkit](https://archlinux.org/packages/extra/x86_64/rtkit/) · [realtime-privileges](https://wiki.archlinux.org/title/Realtime_process_management) · [sound-theme-freedesktop](https://archlinux.org/packages/extra/any/sound-theme-freedesktop/) | | _[Arch Wiki](https://wiki.archlinux.org/title/WirePlumber)_ ➟ systemctl --user enable --now wireplumber ➟ sudo systemctl enable --now rtkit-daemon.service |
...
| 📼 FFmpeg              | [ffmpeg](https://archlinux.org/packages/extra/x86_64/ffmpeg/) | [nano-ffmpeg](https://github.com/dgr8akki/nano-ffmpeg) |
| 📑 Misc                | [ffmpegthumbnailer](https://archlinux.org/packages/extra/x86_64/ffmpegthumbnailer/) · [libdvdcss](https://archlinux.org/packages/extra/x86_64/libdvdcss/) · [libopenraw](https://archlinux.org/packages/extra/x86_64/libopenraw/) | [easyeffects](https://github.com/wwmm/easyeffects) |
...
| 📗 Wayland Integration     | [egl-wayland](https://archlinux.org/packages/extra/x86_64/egl-wayland/) · [xorg-xwayland](https://archlinux.org/packages/extra/x86_64/xorg-xwayland/) ﹢ [ [xorg-xrandr](https://wiki.archlinux.org/title/Xrandr) · [xorg-xprop](https://archlinux.org/packages/extra/x86_64/xorg-xprop/) · [xorg-xrdb](https://archlinux.org/packages/extra/x86_64/xorg-xrdb/) ] · [qt5-wayland](https://archlinux.org/packages/extra/x86_64/qt5-wayland) · [qt6-wayland](https://archlinux.org/packages/extra/x86_64/qt6-wayland) · [libinput-tools](https://archlinux.org/packages/extra/x86_64/libinput-tools/) |
...
| 🔐 Authentication Agent    | [polkit](https://wiki.archlinux.org/title/Polkit) · [polkit-gnome](https://archlinux.org/packages/extra/x86_64/polkit-gnome/) | [lxqt-policykit](https://archlinux.org/packages/extra/x86_64/lxqt-policykit/) |
| 🌀 XDG Portal Backend      | [xdg-desktop-portal](https://wiki.archlinux.org/title/XDG_Desktop_Portal) · [xdg-desktop-portal-wlr](https://archlinux.org/packages/extra/x86_64/xdg-desktop-portal-wlr/) · [xdg-desktop-portal-gtk](https://archlinux.org/packages/extra/x86_64/xdg-desktop-portal-gtk/) | [xdg-desktop-portal-lxqt](https://archlinux.org/packages/extra/x86_64/xdg-desktop-portal-lxqt/)
...
| 🖼️ Wallpaper Management       | [swaybg](https://github.com/swaywm/swaybg) ﹢ [waypaper](https://aur.archlinux.org/packages/waypaper) \| [azote](https://archlinux.org/packages/extra/any/azote/) | [pcmanfm-qt](https://github.com/lxqt/pcmanfm-qt) |
...
| 🔔 Notification Daemon        | [mako](https://github.com/emersion/mako) | | [fnott](https://codeberg.org/dnkl/fnott) · [nwg-notifications](https://github.com/jasonherald/nwg-notifications) |
| 📋 Clipboard Management       | [wl-clipboard-rs](https://github.com/YaLTeR/wl-clipboard-rs) ﹢ [wl-clip-persist](https://github.com/Linus789/wl-clip-persist) ﹢ [cliphist](https://github.com/sentriz/cliphist) ﹢ [fuzzel-cliphist.sh](https://github.com/p2ndemic/dotfiles/blob/main/.local/bin/fuzzel-cliphist.sh) | | [wl-clipboard](https://github.com/bugaevc/wl-clipboard) · [clipse](https://github.com/savedra1/clipse)  · [cursor-clip](https://aur.archlinux.org/packages/cursor-clip-git) |
...
|-------------|-------------| ---------|
| 🔸 Theme Manager | _none_ | [qt6ct](https://archlinux.org/packages/extra/x86_64/qt6ct/) · [matugen](https://archlinux.org/packages/extra/x86_64/matugen/) · [nwg-look](https://github.com/nwg-piotr/nwg-look) · [waypaper](https://github.com/anufrievroman/waypaper)|
...
| 🔸 Emoji         | [noto-fonts-emoji](https://archlinux.org/packages/extra/any/noto-fonts-emoji/) ﹢ [noto-color-emoji-fontconfig](https://aur.archlinux.org/packages/noto-color-emoji-fontconfig) | [bemoji](https://github.com/marty-oehme/bemoji) · [ttf-twemoji-color](https://aur.archlinux.org/packages/ttf-twemoji-color) ⤍ _sudo ln -sf /usr/share/fontconfig/conf.avail/46-ttf-twemoji-color.conf /etc/fonts/conf.d/46-ttf-twemoji-color.conf_ |
...
| 📝 GUI Text Editor | [zed](https://github.com/zed-industries/zed) | [vscode](https://wiki.archlinux.org/title/Visual_Studio_Code) \| [notepadNext](https://github.com/dail8859/NotepadNext) \| [featherpad](https://github.com/tsujan/FeatherPad) \| [pragtical](https://github.com/pragtical/pragtical) · [lite-xl](https://github.com/lite-xl/lite-xl) |
...
| 🧰 Monitoring  | [btop](https://github.com/aristocratos/btop) · [mission-center](https://gitlab.com/mission-center-devs/mission-center) · [kmon](https://github.com/orhun/kmon) | | [glances](https://github.com/nicolargo/glances) \| [trippy](https://github.com/fujiapple852/trippy) \| [nvtop](https://github.com/Syllo/nvtop) \| [systemd-manager-tui](https://github.com/matheus-git/systemd-manager-tui) \| [pik](https://github.com/jacek-kurlit/pik) \| [sniffnet](https://github.com/GyulyVGC/sniffnet) |
| 📷 Screenshot       | [screengrab](https://archlinux.org/packages/extra/x86_64/screengrab/) | [grimshot](https://github.com/OctopusET/sway-contrib) \| [wayshot](https://git.sr.ht/~shinyzenith/wayshot) \| [shotman](https://git.sr.ht/~whynothugo/shotman) \| [satty](https://github.com/gabm/satty) \| [wayscriber](https://github.com/devmobasa/wayscriber) |
...
| 🎬 Media Player     | [mpv](https://github.com/mpv-player/mpv) ﹢ [[mpv-ctl.sh](https://github.com/p2ndemic/dotfiles/blob/main/.local/bin/mpv-ctl.sh) ﹢ [ff2mpv](https://github.com/p2ndemic/ff2mpv)]<br>[yt-dlp](https://github.com/yt-dlp/yt-dlp) ﹢ [[python-brotli](https://archlinux.org/packages/core/x86_64/python-brotli/)  ﹢ [python-websockets](https://archlinux.org/packages/extra/x86_64/python-websockets/) ﹢ [python-curl_cffi](https://archlinux.org/packages/extra/x86_64/python-curl_cffi/) ﹢ [python-mutagen](https://archlinux.org/packages/extra/any/python-mutagen/) ﹢ [python-pycryptodomex](https://archlinux.org/packages/extra/x86_64/python-pycryptodomex/)] | [mpris-ctl](https://github.com/mariusor/mpris-ctl) |
