...
| 📗 Wayland Integration     | [egl-wayland](https://archlinux.org/packages/extra/x86_64/egl-wayland/) · [xorg-xwayland](https://archlinux.org/packages/extra/x86_64/xorg-xwayland/) ﹢ [ [xorg-xrandr](https://wiki.archlinux.org/title/Xrandr) · [xorg-xprop](https://archlinux.org/packages/extra/x86_64/xorg-xprop/) · [xorg-xrdb](https://archlinux.org/packages/extra/x86_64/xorg-xrdb/) ] · [qt5-wayland](https://archlinux.org/packages/extra/x86_64/qt5-wayland) · [qt6-wayland](https://archlinux.org/packages/extra/x86_64/qt6-wayland) |
