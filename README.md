...
| 🎬 Media Player     | [mpv](https://github.com/mpv-player/mpv) ﹢ [[mpv-ctl.sh](https://github.com/p2ndemic/dotfiles/blob/main/.local/bin/mpv-ctl.sh) ﹢ [ff2mpv](https://github.com/p2ndemic/ff2mpv)] ﹢ [yt-dlp](https://github.com/yt-dlp/yt-dlp) ﹢ [[python-brotli](https://archlinux.org/packages/core/x86_64/python-brotli/)  ﹢ [python-websockets](https://archlinux.org/packages/extra/x86_64/python-websockets/) ﹢ [python-curl_cffi](https://archlinux.org/packages/extra/x86_64/python-curl_cffi/) ﹢ [python-mutagen](https://archlinux.org/packages/extra/any/python-mutagen/) ﹢ [python-pycryptodomex](https://archlinux.org/packages/extra/x86_64/python-pycryptodomex/)] | [mpris-ctl](https://github.com/mariusor/mpris-ctl) |
