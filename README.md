...
| 📶 Network Drivers & Utils     | iwd · ethtool · [networkmanager](https://wiki.archlinux.org/title/NetworkManager) ﹢ [nm-connection-editor](https://archlinux.org/packages/extra/x86_64/nm-connection-editor/) | https://github.com/pythops/impala |  _sudo systemctl enable --now NetworkManager.service_ |
