...
| 🌡️ Intel Thermal Daemon |  | [thermald](https://archlinux.org/packages/extra/x86_64/thermald/) | _[Arch Wiki](https://wiki.archlinux.org/title/CPU_frequency_scaling#thermald)_ ➟ _sudo systemctl enable --now thermald_ _(Not recommended, as it may cause lag)_ |
