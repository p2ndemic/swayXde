...
| 🌍 iwd \| _Connect to a Network_ | [iwd](https://archlinux.org/packages/extra/x86_64/iwd/) ﹢ [iwgtk](https://aur.archlinux.org/packages/iwgtk) | | _[iwd Wiki](https://wiki.archlinux.org/title/Iwd)_ ➟ _[iwd Man](https://man.archlinux.org/man/iwctl.1)_ ➟ _[iwd_config](https://github.com/p2ndemic/dotfiles/blob/main/etc/iwd/main.conf)_ ➟ _**Connect to a network**_ ➟ _**[Command line mode]**_ ➟ _**iwctl --help**_ ➟ _**iwctl device list**_ ➟ _**iwctl station DEVICE scan**_ ➟ _**iwctl station DEVICE get-networks**_ ➟ _**iwctl --passphrase=PASSPHRASE station DEVICE connect SSID**_ \| _**[Interactive mode]**_ ➟ _**iwctl**_ ➟ _**help**_ ➟ **_..._**| 
