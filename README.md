...
| 🧱 Bar & OSD           | [waybar](https://github.com/Alexays/Waybar) ﹢ [swayosd](https://github.com/ErikReider/SwayOSD) [fuzzel-custom-menu](https://github.com/p2ndemic/dotfiles/blob/main/.local/bin/fuzzel-launcher-index.sh) | [ironbar](https://github.com/JakeStanger/ironbar) \| [gbar](https://aur.archlinux.org/packages/gbar-git) \| [ashell](https://aur.archlinux.org/packages/ashell) |
