...
| 🕒 NTP Daemon         | [systemd-timesyncd](https://www.freedesktop.org/software/systemd/man/latest/systemd-timesyncd.service.html) | [chrony](https://wiki.archlinux.org/title/Chrony) | _[Arch Wiki](https://wiki.archlinux.org/title/Systemd-timesyncd)_ ➟ _[timesyncd_config](https://github.com/p2ndemic/dotfiles/blob/main/etc/systemd/timesyncd.conf.d/local.conf)_ ➟ _sudo systemctl enable --now systemd-timesyncd_ |
