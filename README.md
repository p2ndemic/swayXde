...
| 📶 Network Drivers & Utils     | iwd · ethtool · [networkmanager](https://wiki.archlinux.org/title/NetworkManager) ﹢ [nm-connection-editor](https://archlinux.org/packages/extra/x86_64/nm-connection-editor/) | https://github.com/pythops/impala |  _sudo systemctl enable --now NetworkManager.service_ [Enable the iwd backend for NetworkManager](https://wiki.archlinux.org/title/NetworkManager#Using_iwd_as_the_Wi-Fi_backend) · [iwd config wiki](https://archive.kernel.org/oldwiki/iwd.wiki.kernel.org/networkmanager.html#converting_network_profiles) |
...
[thermald](https://wiki.archlinux.org/title/CPU_frequency_scaling#thermald)
