...
| 🎬 Media Player     | [mpv](https://github.com/mpv-player/mpv) ﹢ [yt-dlp](https://github.com/yt-dlp/yt-dlp) ﹢ [mpv-ctl.sh](https://github.com/p2ndemic/dotfiles/blob/main/.local/bin/mpv-ctl.sh) | [mpris-ctl](https://github.com/mariusor/mpris-ctl) |
