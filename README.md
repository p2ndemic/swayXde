...
| 🔸 Emoji         | [noto-fonts-emoji](https://archlinux.org/packages/extra/any/noto-fonts-emoji/) ﹢ [noto-color-emoji-fontconfig](https://aur.archlinux.org/packages/noto-color-emoji-fontconfig) | [ttf-twemoji-color](https://aur.archlinux.org/packages/ttf-twemoji-color) · [bemoji](https://github.com/marty-oehme/bemoji) |
