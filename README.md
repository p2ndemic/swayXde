...
| Module Type | Module Name | Optional | Note |
|-------------|-------------|----------|------|
| 🔹 Intel Microcode      | [intel-ucode](https://archlinux.org/packages/extra/any/intel-ucode/) | [intel-gpu-tools](https://archlinux.org/packages/extra/x86_64/intel-gpu-tools/) | _[Arch Wiki](https://wiki.archlinux.org/title/Microcode)_ |
...
| 🌬️ Intel GPU Tools      | _optional_ | [intel-gpu-tools](https://archlinux.org/packages/extra/x86_64/intel-gpu-tools/) |
